...
public class StopCoordinate extends Coordinate {
    ...
    public void markStopTime(){
        ...
        String month = formatter.format(Integer.parseInt(timeInstance.monthOfYear().getAsString())).toString();
        String day = formatter.format(Integer.parseInt(timeInstance.dayOfMonth().getAsString())).toString();
